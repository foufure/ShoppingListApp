...
namespace ShoppingListApp.Domain.Test
{
    ...
    public class ShoppingListXmlRepositoryTest
    {
        ...
        public void ShoppingListAddedToPersistentRepository_WhenWrittenToXmlFileRepository()
        {
            ...
            shoppingListNext.ShoppingListContent.Add(new ShoppingListLine() { ItemToBuy = new Item() { ItemId = 1, ItemName = "Item4" }, QuantityToBuy = 1 });
            shoppingListNext.ShoppingListContent.Add(new ShoppingListLine() { ItemToBuy = new Item() { ItemId = 2, ItemName = "Item5" }, QuantityToBuy = 1 });
            shoppingListNext.ShoppingListContent.Add(new ShoppingListLine() { ItemToBuy = new Item() { ItemId = 3, ItemName = "Item6" }, QuantityToBuy = 2 });
