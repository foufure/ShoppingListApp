...
namespace Selenium_SpecFlow.Support
{
    public static class WebDriverExtensions
    {
        ...
        public static void ClickButton(this IWebDriver browser, string buttonName)
        {
            browser.FindElements(By.Name(buttonName)).First().Click();
        }

        public static void ClickButtonId(this IWebDriver browser, string buttonName)
        {
            browser.FindElements(By.Id(buttonName)).First().Click();
        }
